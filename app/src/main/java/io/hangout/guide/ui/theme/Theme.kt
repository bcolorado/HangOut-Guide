...
val LocalStatusColor = compositionLocalOf { StatusColor(
    success = extendedLight.success,
    error = extendedLight.danger,
    warning = extendedLight.warning
) }


@Composable
fun HangOutGuideTheme(
    ...
    val statusColor = when {
        darkTheme -> {
            StatusColor(
                success = extendedDark.success,
                error = extendedDark.danger,
                warning = extendedDark.warning
            )
        }
        else -> {
            StatusColor(
    ...
    CompositionLocalProvider(
        ...
        LocalStatusColor provides statusColor
    ) {
        MaterialTheme(
